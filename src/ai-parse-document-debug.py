...
# MAGIC Version 1.2
# MAGIC
# MAGIC Last update: Thu Oct 6, 2025
# MAGIC
# MAGIC Changelog:
# MAGIC - If `input_file` is not set, process all files inside the input directory.
# MAGIC
# MAGIC ## Overview
...
# MAGIC
# MAGIC 2. Create two directories named **input** and **output** in your volume, and upload your PDF files to the input directory.
# MAGIC
# MAGIC 3. **Set the parameters** in the input boxes at the top of this notebook before running any code
# MAGIC    
