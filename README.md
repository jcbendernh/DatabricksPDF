...
Using the [ai_query function](https://learn.microsoft.com/en-us/azure/databricks/sql/language-manual/functions/ai_query), you can further curate the data into separate field via LLMs.  This is showcased in the [PDF Gold](src/PDF%20-%20Gold.ipynb) notebook.
